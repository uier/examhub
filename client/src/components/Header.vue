    ...
    <div class="h-16 px-6 max-w-7xl mx-auto flex items-stretch">
      ...
      <div class="flex-1 flex items-stretch justify-end">
        <router-link
          ...
          class="md:text-lg flex-1 hover:bg-rose-200 flex items-center justify-center"
        >
          首頁
        </router-link>
        <router-link
